...
export declare class ChartistComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ChartistComponent, "x-chartist", never, { "configuration": string; "events": string; }, { "initialized": "initialized"; }, never, never, false, never>;
}
export {};
